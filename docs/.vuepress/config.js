...
module.exports = {
  ...
  "head": [
    ...
    ['link', { rel: 'apple-touch-icon', href: './public/icons/144.png' }],
    ['link', { rel: 'mask-icon', href: './public/icons/144.png', color: '#3eaf7c' }],
    ['meta', { name: 'msapplication-TileImage', content: './public/icons/144.png' }],
